...
const leftFeatures: FeatureItem[] = [
  {
    ...
    description:
      "Generate intelligent assignments instantly for any subject and difficulty level using advanced AI.",
    position: "left",
  ...
  },
  {
    ...
    description:
      "Share assignments via secure links or QR codes. Students can submit work without sign-up.",
    position: "left",
    cornerStyle: "sm:-translate-x-4 sm:rounded-br-[2px]",
  },
  {
    ...
    description:
      "Get automated, detailed analysis of student submissions including scores, strengths, and suggestions.",
    position: "left",
...
const rightFeatures: FeatureItem[] = [
  {
    ...
    description:
      "Track assignment progress, review submissions, and manage your classes efficiently.",
    position: "right",
  ...
  },
  {
    ...
    description:
      "Students receive actionable feedback and improvement suggestions tailored to their answers.",
    position: "right",
    cornerStyle: "sm:translate-x-4 sm:rounded-bl-[2px]",
  },
  {
    icon: Lightbulb,
    title: "Model Answers & Learning",
    description:
      "Compare student submissions with AI-generated model answers to enhance learning outcomes.",
    position: "right",
        ...
        <div className="flex flex-col-reverse gap-6 md:grid md:grid-cols-3">
          ...
          <div className="order-[1] mb-6 self-center sm:order-[0] md:mb-0">
            ...
            <p className="text-muted-foreground mx-auto max-w-[18rem] text-center text-pretty">
              Gradio streamlines assignment creation, sharing, and AI-powered
