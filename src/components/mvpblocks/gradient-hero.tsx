...
export default function GradioHero() {
  return (
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            <div className="border-border bg-background/80 inline-flex items-center rounded-full border px-3 py-1 text-sm backdrop-blur-sm">
              <span className="bg-primary text-primary-foreground mr-2 rounded-full px-2 py-0.5 text-xs font-semibold shadow">
                AI Powered
              </span>
              <span className="text-muted-foreground">
                Revolutionizing assignment review for teachers & students
              </span>
          ...
          >
            Effortless Assignment Review with AI for Teachers & Students
          </motion.h1>
          ...
          >
            Gradio streamlines the assignment review process using AI, enabling
            teachers to provide instant, insightful feedback and helping
            students improve their submissions. Save time, enhance learning, and
            foster collaboration with automated grading and personalized
            suggestions.
          </motion.p>
            ...
            <div className="border-border/40 bg-background/50 overflow-hidden rounded-xl border shadow-xl backdrop-blur-sm">
              <div className="border-border/40 bg-muted/50 flex h-10 items-center border-b px-4">
                ...
                <div className="bg-background/50 text-muted-foreground mx-auto flex items-center rounded-md px-3 py-1 text-xs">
                  https://gradio-ai.vercel.app/
                </div>
              </div>
              <div className="relative">
                <img
                  src="https://i.postimg.cc/0yk8Vz7t/dashboard.webp"
                  alt="Gradio Assignment Review Dashboard"
                  className="w-full"
                />
